  ...
  const features = [
    {
      ...
      description: "Launch your MVP in just 2-4 weeks.",
      icon: <Zap />,
    },
    {
    ...
    },
    {
      ...
      description:
        "Guaranteed 100% uptime for uninterrupted access to your MVP.",
      icon: <Activity />,
    },
    {
      title: "Proven Expertise",
      description:
        "With years of experience, we know how to get your idea to market quickly and effectively.",
      icon: <Users />,
    },
  ];
...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-10 text-[#2c5688]">{icon}</div>
