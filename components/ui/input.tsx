  ...
  ({ className, hasIcon, children, ...props }, ref) => {
    return (
      <div className="mt-2 flex w-full rounded-md ">
        <div
          className={cn(
            "relative w-full before:pointer-events-none before:absolute before:-inset-1 before:rounded-[9991px] before:border before:border-accent/20 before:opacity-0 before:ring-2 before:ring-neutral-100/40 before:transition dark:before:border-blue-400/40 dark:before:ring-2 dark:before:ring-blue-900/40",
            ...
            "focus-within:before:opacity-100 focus-within:after:shadow-neutral-100/20 dark:after:shadow-white/5 dark:focus-within:after:shadow-blue-500/30"
          )}
        >
          <input
            type="search"
